...
cent.innerHTML = "Pagination";


var division1 = document.createElement("div");
division1.setAttribute("id", "container");
division1.setAttribute("class", "container");



var nxline = document.createElement("br")
document.body.append(first,division1,nxline);
first.appendChild(cent)

var tables = document.createElement("table");
tables.setAttribute("class", "table table-dark");
tables.setAttribute("id", "our-table");
division1.appendChild(tables);


var tablehead = document.createElement("thead");
tablehead.innerHTML = `<tr><th>ID</th><th>Name</th><th>Email</th></tr>`;

tables.appendChild(tablehead);


var tablesbody = document.createElement("tbody");
tablesbody.setAttribute("id", "table-body");
tables.appendChild(tablesbody);


var pcontain = document.createElement("div");
pcontain.setAttribute("id", "pcontainer");
pcontain.setAttribute("class", "container2");
division1.appendChild(pcontain);

var pwrapper = document.createElement("div");
pwrapper.setAttribute("id", "pagination-wrapper");
pcontain.appendChild(pwrapper);
...
function pagination(querySet, page, rows) {
  ...
  var end = start + rows;
  var trimmed = querySet.slice(start, end);
